...
/*! feed.js | Yammertime */
var Yt=Yt||{};Yt.Feed=Yt.Feed||{},function(a,b,c,d){var e=Yt.Util;a.getOrCreateTopicId=function(a,b,c){yam.platform.request({url:"https://api.yammer.com/api/v1/topics",type:"POST",data:"name="+a,dataType:"json",success:b,error:c})},a.loadGroups=function(a){yam.platform.request({url:"https://api.yammer.com/api/v1/groups?mine=1",type:"GET",dataType:"json",success:a,error:e.requestErrorHandler})},a.loadMessages=function(a,b){yam.platform.request({url:"https://api.yammer.com"+a,type:"GET",dataType:"json",success:b,error:e.requestErrorHandler})},a.loadNetworks=function(a){yam.platform.request({url:"https://api.yammer.com/api/v1/networks/current",type:"GET",dataType:"json",success:a,error:e.requestErrorHandler})},a.loadTokens=function(a){yam.platform.request({url:"https://api.yammer.com/api/v1/oauth/tokens",type:"GET",dataType:"json",success:function(b){$.each(b,function(b,c){a.accessTokens[c.network_permalink]||(a.accessTokens[c.network_permalink]=c)})},error:e.requestErrorHandler})}}(Yt.Feed,window,document,void 0);
/*! settings.js | Yammertime */
