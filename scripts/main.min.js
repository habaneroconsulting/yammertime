...
/*! main.js | Yammertime */
!function(a,b,c,d,e){function f(){J.bindEvents(),L.closeButton.on("click",g),L.container.on("click","a.view-replies",z),L.container.on("click","a.older-replies",u),L.logout.on("click",o),L.feed.on("click","."+M.tile,h),L.feed.on("tilePosts",B),L.feed.on("retrieveFeed",v),a(e).on("keyup",m),l()}function g(){L.settingsDialog.addClass(M.hidden),L.overlayExpanded.addClass(M.hidden),L.overlay.addClass(M.hidden),H.toggleScroll(),L.repliesExpanded.html(""),L.repliesExpanded.html(L.spinner.show())}function h(){var b=a(this).attr("id");L.overlayExpanded.toggleClass(M.hidden),L.overlay.toggleClass(M.hidden),L.postExpanded.html(""),L.postExpanded.attr("id",b).html(a(this).html()),y(b),H.toggleScroll()}function i(){a(".creationdate").each(function(){var c=a(this).data("time"),d=b(c).fromNow(),e=" "+d;a(this).text(e)})}function j(){J.get(O.tiled)?B():(L.container.removeClass(M.tiled_view),L.settingsDialog.removeClass(M.pushSettings))}function k(){for(var a,b=[],c=d.location.href.slice(d.location.href.indexOf("?")+1).split("&"),e=0;e<c.length;e++)a=c[e].split("="),b.push(a[0]),b[a[0]]=a[1];return b}function l(){function b(){c=0}{var c=0,d=a(this);setInterval(function(){c+=1,c===N.idleWait&&(L.body.animate({scrollTop:0}),L.overlayExpanded.hasClass(M.hidden)||g())},6e4)}d.mousemove(b),d.keypress(b),d.scroll(b)}function m(a){27!==a.which||L.overlayExpanded.hasClass(M.hidden)||g()}function n(a){L.landing.addClass(M.hidden),L.header.removeClass(M.hidden),f(),J.set(O.networkPermalink,a.access_token.network_permalink);J.get(O.networkPermalink);J.set(O.networkId,a.access_token.network_name),I.loadTokens(N),I.loadNetworks(J.addNetworks),I.loadGroups(J.addGroups);var b=k(),c={bgColor:"#455560",groupId:"-1",olderReplies:"false",logoUrl:"",postRotation:"false",showSticky:"false",stickyDate:0,textSize:"small",truncate:"false",tiled:"true",yammerLinks:"false"};if(J.get(O.noDefaults)||b[b[0]]){if(b[b[0]]){for(var d=0;d<b.length;d++)c[b[d]]=b[b[d]];J.set(c)}}else J.set(c);J.initStyleSettings(),v(),setInterval(C,N.showDelay),setInterval(x,N.animationDelay)}function o(){yam.logout(function(){location.reload()})}function p(a){var c=[];if(J.get(O.showSticky)){for(var d=0;d<a.length;d++)"announcement"===a[d].message_type&&(c.push(a[d]),a.splice(d,1),d--);c.length>0?(stickyDate=b(c[0].created_at).format("X"),stickyDate>=J.get(O.stickyDate)&&(c='<p datetime="'+c[0].created_at+'">'+c[0].body.plain+"</p>",J.set(O.sticky,c),J.set(O.stickyDate,stickyDate),s())):J.get(O.sticky)&&s()}else J.set(O.stickyDate,0),L.sticky.addClass(M.hidden);return a}function q(a){var b={},c={},d=J.get(O.yammerLinks);for(var e in a.references)if(a.references.hasOwnProperty(e)){var f=a.references[e];"user"===f.type?(b[f.id]=f,b[f.name]=f):"message"===f.type?c[f.id]=f:"group"===f.type?b[f.id]=f:"thread"===f.type&&(b[f.id]=f)}for(e in a.messages)if(a.messages.hasOwnProperty(e)){var g=a.messages[e];if(g.sender_id&&(g.mugshot_url=b[g.sender_id].mugshot_url.replace("48x48","96x96"),g.full_name=b[g.sender_id].full_name,g.username=b[g.sender_id].name),g.thread_id&&(g.thread_stats=b[g.thread_id].stats),"-1"===J.get(O.groupId)&&g.group_id&&(g.group_name=b[g.group_id].full_name,g.group_url=b[g.group_id].web_url),0===g.body.rich.indexOf("(See attached"))for(var h in g.attachments)if(g.attachments.hasOwnProperty(h)){var i=g.attachments[h];i.ymodule&&(g.body.rich=i.name)}g.body.rich=g.body.rich.replace(/br><br/g,"br"),d&&(g.body.rich=g.body.rich.replace("href='https://www.yammer.com","'"),g.body.rich=g.body.rich.replace('href="https://www.yammer.com','"')),g.replied_to_id&&(c[g.replied_to_id]?c[g.replied_to_id].sender_id&&(in_reply_to=b[c[g.replied_to_id].sender_id],g.in_reply_to=in_reply_to.full_name):g.replied_to_id=null)}return a.messages}function r(a){var b=q(a),c=b.length;c>0&&(b=p(b),b=A(b),t(b),i(),j(b))}function s(){b().format("X")-J.get(O.stickyDate)<604800?(L.sticky.html(sticky),L.sticky.removeClass(M.hidden)):(J.set(O.sticky,""),J.set(O.stickyDate,""),L.sticky.addClass(M.hidden),L.sticky.html(""))}function t(b){var c,d,e,f,g,h=J.get(O.postId)||"",i=b.length,j=J.get(O.olderReplies);if(e=i>0?b[0].thread_stats.updates:!1,f=J.get(O.tiled)?K.tile:K.message,g=f(b),g=Array.prototype.slice.call(a(g)),g=g.reverse(),h.length>0){if(d=J.get(O.modalPostAppend)?L.repliesExpanded:a("#"+h),J.get(O.tiled)){var k="",l=function(){var a={thread_id:h,thread_stats:{updates:e}};return E(a),"<h2>"+k+"</h2>"};i>0&&i<=N.messageLimit?(c=1===i?" reply":" replies",k='<span class="num">'+i.toString()+"</span>"+c):k=i===N.messageLimit&&i!==e-1?"Latest replies":"No replies yet :(",d.append(l)}if(a(g).appendTo(d),i===N.messageLimit&&i!==e-1){e=e-N.messageLimit>N.messageLimit?N.messageLimit:e-N.messageLimit-1,c=1===e?" message":" messages";var m='<a href="#" id="'+b[i-1].id+'" class="older-replies">View <span class="num">'+e+'</span> older <span class="sores">'+c+"</span></a>";a(m).insertAfter(d.find("h2"))}L.spinner.hide(),D(i,d),J.set(O.appendPostReplies,"false"),J.set(O.modalPostAppend,"false"),J.set(O.postId,"")}else if(j){var n=parseInt(L.repliesExpanded.find("h2").find(".num").text());a(g).insertAfter(a(".older-replies")),N.updateCount<N.messageLimit&&(N.updateCount=N.messageLimit),e-N.updateCount-1<=N.messageLimit?(a(".older-replies").remove(),N.updateCount=N.messageLimit):(a(".older-replies").attr("id",b[i-1].id),N.updateCount+=i,e-N.updateCount===2&&(a(".older-replies").find(".sores").text("message"),a(".older-replies").find(".num").text("1"))),L.repliesExpanded.find("h2").find(".num").text(n+i),J.set(O.olderReplies,"false")}else g=g.reverse(),a(g).prependTo(L.feed),N.oldLastMessageId=N.lastMessageId,D(i)}function u(b){b.preventDefault();var c=a(this).attr("id"),d=a(this).parents("section").find(".post-expanded").attr("id");J.set(O.olderReplies,"true"),I.loadMessages("/api/v1/messages/in_thread/"+d+"?older_than="+c+"&limit="+N.messageLimit,r)}function v(){N.lastMessageId=0,N.oldLastMessageId=0,L.feed.html(""),L.sticky.html("");var a=J.get(O.groupId),b=J.get(O.topicId);a&&H.isInt(a)&&-1!=a?I.loadMessages("/api/v1/messages/in_group/"+a+"?threaded=true&limit="+N.messageLimit,r):b&&H.isInt(b)?I.loadMessages("/api/v1/messages/about_topic/"+b+"?threaded=true&limit="+N.messageLimit,r):I.loadMessages("/api/v1/messages?threaded=true&limit="+N.messageLimit,r)}function w(){a(".feed .yam:last").animate({opacity:"0"},500,function(){var b=a(this);b.prependTo(L.feed).css({opacity:"1",display:"none"}).slideDown("slow")})}function x(){!J.get(O.tiled)&&J.get(O.postRotation)&&w()}function y(a){J.set(O.postId,a),J.set(O.appendPostReplies,"true"),J.set(O.modalPostAppend,"true"),I.loadMessages("/api/v1/messages/in_thread/"+a+"?limit="+N.messageLimit,r)}function z(b){b&&b.preventDefault();var c=a(this);if(c.hasClass(M.viewReplies)&&0===c.parents(".yam").find(".reply").length){var d=c[0].hash.slice(1),e=c.parents(".yam")[0].id;J.set(O.appendPostReplies,"true"),J.set(O.postId,e),I.loadMessages("/api/v1/messages/in_thread/"+d,r)}else c.parents(".yam").find(".reply").toggle(),c.parents(".yam").find(".reply").remove()}function A(b){for(var c=0;c<b.length;c++)if(b[c].id>N.lastMessageId)N.lastMessageId=b[c].id;else if(0!==N.oldLastMessageId&&"true"!==J.get(O.appendPostReplies)){E(b[c]);var d=b[c].id,e=a("#"+d);e.length>0&&(b.splice(c,1),c--)}return b}function B(){var b=a(".feed > div");b.addClass(M.tile),b.each(function(){var b=a(this);if(b.find(".messagebody").first()){var c=a(b.find(".messagebody").first()[0]).text().replace("(less)","").trim();b.addClass(c.length>750?M.largeTile:c.length>500?M.mediumTile:M.smallTile)}}),L.container.addClass(M.tiled_view),a(".feed .yam").length&&(L.feed.masonry("reloadItems"),L.feed.masonry({itemSelector:".tile",gutter:20,columnWidth:355}))}function C(){if(i(),N.count%N.loadDelay===0){var a=J.get(O.groupId),b=J.get(O.topicId);a&&H.isInt(a)&&"-1"!==a?I.loadMessages("/api/v1/messages/in_group/"+a+"?threaded=true&newer_than="+N.lastMessageId,r):b&&H.isInt(b)?I.loadMessages("/api/v1/messages/about_topic/"+b+"?threaded=true&newer_than="+N.lastMessageId,r):I.loadMessages("/api/v1/messages?threaded=true&newer_than="+N.lastMessageId,r)}N.count%N.showDelay===0&&(N.count=N.count+N.showDelay)}function D(b,c){if(J.get(O.truncate)&&!J.get(O.tiled))if(c){var d;d=2===c.find(".message").first().find("span.messagebody").length?2:1;for(var e=d;b+1>e;e++)a(c.find("span.messagebody")[e]).truncate({max_length:275})}else for(var f=L.feed.find("span.messagebody"),g=0;b>g;g++)a(f[g]).truncate({max_length:275})}function E(b){var c=a("#"+b.thread_id.toString()),d=c.find("."+M.replyNumber);if(d.length>0)d.text((b.thread_stats.updates-1).toString()),b.thread_stats.updates>2?d.next().text("replies"):2===b.thread_stats.updates?d.next().text("reply"):d.parents(".replies").remove();else if(2===b.thread_stats.updates){var e='<div class="'+M.replies+'"><a href="#'+b.thread_id+'" class="'+M.viewReplies+'"><span class="'+M.replyNumber+'">1</span> <span>reply</span></a></div>',f=c.find(".message");a(e).insertAfter(f)}}function F(){yam.getLoginStatus(function(a){a.authResponse?n(a):(L.landing.removeClass(M.hidden),yam.connect.loginButton("#yammer-login",function(a){a.authResponse&&n(a)}))})}var G=Yt.Constants,H=Yt.Util,I=Yt.Feed,J=Yt.Settings,K=Yt.Templates,L=(J.oauth,H.getElements()),M=G.classes,N=G.defaultConfig,O=G.settingKeys;F()}(jQuery,moment,Handlebars,window,document);