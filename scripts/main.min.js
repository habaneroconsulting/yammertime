...
/*! main.js | Yammertime */
!function(a,b,c,d,e){function f(){J.bindEvents(),M.closeButton.on("click",g),M.container.on("click","a.view-replies",z),M.container.on("click","a.older-replies",u),M.logout.on("click",o),M.feed.on("click","."+N.tile,h),M.feed.on("tilePosts",B),M.feed.on("retrieveFeed",v),a(e).on("keyup",m),l()}function g(){M.settingsDialog.addClass(N.hidden),M.overlayExpanded.addClass(N.hidden),M.overlay.addClass(N.hidden),H.toggleScroll(),M.repliesExpanded.html(""),M.repliesExpanded.html(M.spinner.show())}function h(){var b=a(this).attr("id");M.overlayExpanded.toggleClass(N.hidden),M.overlay.toggleClass(N.hidden),M.postExpanded.html(""),M.postExpanded.attr("id",b).html(a(this).html()),y(b),H.toggleScroll()}function i(){a(".creationdate").each(function(){var c=a(this).data("time"),d=b(c).fromNow(),e=" "+d;a(this).text(e)})}function j(){J.get(P.tiled)?B():(M.container.removeClass(N.tiled_view),M.settingsDialog.removeClass(N.pushSettings))}function k(){for(var a,b=[],c=d.location.href.slice(d.location.href.indexOf("?")+1).split("&"),e=0;e<c.length;e++)a=c[e].split("="),b.push(a[0]),b[a[0]]=a[1];return b}function l(){function b(){c=0}{var c=0,d=a(this);setInterval(function(){c+=1,c===O.idleWait&&(M.body.animate({scrollTop:0}),M.overlayExpanded.hasClass(N.hidden)||g())},6e4)}d.mousemove(b),d.keypress(b),d.scroll(b)}function m(a){27!==a.which||M.overlayExpanded.hasClass(N.hidden)||g()}function n(a){M.landing.addClass(N.hidden),M.header.removeClass(N.hidden),f(),J.set(P.networkPermalink,a.access_token.network_permalink);var b=J.get(P.networkPermalink);J.set(P.networkId,a.access_token.network_name),I.loadTokens(O),L=yam.request.getAuthenticator(),L.setAuthToken(O.accessTokens[b]),I.loadNetworks(J.addNetworks),I.loadGroups(J.addGroups);var c=k(),d={bgColor:"#455560",groupId:"-1",olderReplies:"false",logoUrl:"",postRotation:"false",showSticky:"false",stickyDate:0,textSize:"small",truncate:"false",tiled:"true",yammerLinks:"false"};if(J.get(P.noDefaults)||c[c[0]]){if(c[c[0]]){for(var e=0;e<c.length;e++)d[c[e]]=c[c[e]];J.set(d)}}else J.set(d);J.initStyleSettings(),v(),setInterval(C,O.showDelay),setInterval(x,O.animationDelay)}function o(){yam.logout(function(){location.reload()})}function p(a){var c=[];if(J.get(P.showSticky)){for(var d=0;d<a.length;d++)"announcement"===a[d].message_type&&(c.push(a[d]),a.splice(d,1),d--);c.length>0?(stickyDate=b(c[0].created_at).format("X"),stickyDate>=J.get(P.stickyDate)&&(c='<p datetime="'+c[0].created_at+'">'+c[0].body.plain+"</p>",J.set(P.sticky,c),J.set(P.stickyDate,stickyDate),s())):J.get(P.sticky)&&s()}else J.set(P.stickyDate,0),M.sticky.addClass(N.hidden);return a}function q(a){var b={},c={},d=J.get(P.yammerLinks);for(var e in a.references)if(a.references.hasOwnProperty(e)){var f=a.references[e];"user"===f.type?(b[f.id]=f,b[f.name]=f):"message"===f.type?c[f.id]=f:"group"===f.type?b[f.id]=f:"thread"===f.type&&(b[f.id]=f)}for(e in a.messages)if(a.messages.hasOwnProperty(e)){var g=a.messages[e];if(g.sender_id&&(g.mugshot_url=b[g.sender_id].mugshot_url.replace("48x48","96x96"),g.full_name=b[g.sender_id].full_name,g.username=b[g.sender_id].name),g.thread_id&&(g.thread_stats=b[g.thread_id].stats),"-1"===J.get(P.groupId)&&g.group_id&&(g.group_name=b[g.group_id].full_name,g.group_url=b[g.group_id].web_url),0===g.body.rich.indexOf("(See attached"))for(var h in g.attachments)if(g.attachments.hasOwnProperty(h)){var i=g.attachments[h];i.ymodule&&(g.body.rich=i.name)}g.body.rich=g.body.rich.replace(/br><br/g,"br"),d&&(g.body.rich=g.body.rich.replace("href='https://www.yammer.com","'"),g.body.rich=g.body.rich.replace('href="https://www.yammer.com','"')),g.replied_to_id&&(c[g.replied_to_id]?c[g.replied_to_id].sender_id&&(in_reply_to=b[c[g.replied_to_id].sender_id],g.in_reply_to=in_reply_to.full_name):g.replied_to_id=null)}return a.messages}function r(a){var b=q(a),c=b.length;c>0&&(b=p(b),b=A(b),t(b),i(),j(b))}function s(){b().format("X")-J.get(P.stickyDate)<604800?(M.sticky.html(sticky),M.sticky.removeClass(N.hidden)):(J.set(P.sticky,""),J.set(P.stickyDate,""),M.sticky.addClass(N.hidden),M.sticky.html(""))}function t(b){var c,d,e,f,g,h=J.get(P.postId)||"",i=b.length,j=J.get(P.olderReplies);if(e=i>0?b[0].thread_stats.updates:!1,f=J.get(P.tiled)?K.tile:K.message,g=f(b),g=Array.prototype.slice.call(a(g)),g=g.reverse(),h.length>0){if(d=J.get(P.modalPostAppend)?M.repliesExpanded:a("#"+h),J.get(P.tiled)){var k="",l=function(){var a={thread_id:h,thread_stats:{updates:e}};return E(a),"<h2>"+k+"</h2>"};i>0&&i<=O.messageLimit?(c=1===i?" reply":" replies",k='<span class="num">'+i.toString()+"</span>"+c):k=i===O.messageLimit&&i!==e-1?"Latest replies":"No replies yet :(",d.append(l)}if(a(g).appendTo(d),i===O.messageLimit&&i!==e-1){e=e-O.messageLimit>O.messageLimit?O.messageLimit:e-O.messageLimit-1,c=1===e?" message":" messages";var m='<a href="#" id="'+b[i-1].id+'" class="older-replies">View <span class="num">'+e+'</span> older <span class="sores">'+c+"</span></a>";a(m).insertAfter(d.find("h2"))}M.spinner.hide(),D(i,d),J.set(P.appendPostReplies,"false"),J.set(P.modalPostAppend,"false"),J.set(P.postId,"")}else if(j){var n=parseInt(M.repliesExpanded.find("h2").find(".num").text());a(g).insertAfter(a(".older-replies")),O.updateCount<O.messageLimit&&(O.updateCount=O.messageLimit),e-O.updateCount-1<=O.messageLimit?(a(".older-replies").remove(),O.updateCount=O.messageLimit):(a(".older-replies").attr("id",b[i-1].id),O.updateCount+=i,e-O.updateCount===2&&(a(".older-replies").find(".sores").text("message"),a(".older-replies").find(".num").text("1"))),M.repliesExpanded.find("h2").find(".num").text(n+i),J.set(P.olderReplies,"false")}else g=g.reverse(),a(g).prependTo(M.feed),O.oldLastMessageId=O.lastMessageId,D(i)}function u(b){b.preventDefault();var c=a(this).attr("id"),d=a(this).parents("section").find(".post-expanded").attr("id");J.set(P.olderReplies,"true"),I.loadMessages("/api/v1/messages/in_thread/"+d+"?older_than="+c+"&limit="+O.messageLimit,r)}function v(){O.lastMessageId=0,O.oldLastMessageId=0,M.feed.html(""),M.sticky.html("");var a=J.get(P.groupId),b=J.get(P.topicId);a&&H.isInt(a)&&-1!=a?I.loadMessages("/api/v1/messages/in_group/"+a+"?threaded=true&limit="+O.messageLimit,r):b&&H.isInt(b)?I.loadMessages("/api/v1/messages/about_topic/"+b+"?threaded=true&limit="+O.messageLimit,r):I.loadMessages("/api/v1/messages?threaded=true&limit="+O.messageLimit,r)}function w(){a(".feed .yam:last").animate({opacity:"0"},500,function(){var b=a(this);b.prependTo(M.feed).css({opacity:"1",display:"none"}).slideDown("slow")})}function x(){!J.get(P.tiled)&&J.get(P.postRotation)&&w()}function y(a){J.set(P.postId,a),J.set(P.appendPostReplies,"true"),J.set(P.modalPostAppend,"true"),I.loadMessages("/api/v1/messages/in_thread/"+a+"?limit="+O.messageLimit,r)}function z(b){b&&b.preventDefault();var c=a(this);if(c.hasClass(N.viewReplies)&&0===c.parents(".yam").find(".reply").length){var d=c[0].hash.slice(1),e=c.parents(".yam")[0].id;J.set(P.appendPostReplies,"true"),J.set(P.postId,e),I.loadMessages("/api/v1/messages/in_thread/"+d,r)}else c.parents(".yam").find(".reply").toggle(),c.parents(".yam").find(".reply").remove()}function A(b){for(var c=0;c<b.length;c++)if(b[c].id>O.lastMessageId)O.lastMessageId=b[c].id;else if(0!==O.oldLastMessageId&&"true"!==J.get(P.appendPostReplies)){E(b[c]);var d=b[c].id,e=a("#"+d);e.length>0&&(b.splice(c,1),c--)}return b}function B(){var b=a(".feed > div");b.addClass(N.tile),b.each(function(){var b=a(this);if(b.find(".messagebody").first()){var c=a(b.find(".messagebody").first()[0]).text().replace("(less)","").trim();b.addClass(c.length>750?N.largeTile:c.length>500?N.mediumTile:N.smallTile)}}),M.container.addClass(N.tiled_view),a(".feed .yam").length&&(M.feed.masonry("reloadItems"),M.feed.masonry({itemSelector:".tile",gutter:20,columnWidth:355}))}function C(){if(i(),O.count%O.loadDelay===0){var a=J.get(P.groupId),b=J.get(P.topicId);a&&H.isInt(a)&&"-1"!==a?I.loadMessages("/api/v1/messages/in_group/"+a+"?threaded=true&newer_than="+O.lastMessageId,r):b&&H.isInt(b)?I.loadMessages("/api/v1/messages/about_topic/"+b+"?threaded=true&newer_than="+O.lastMessageId,r):I.loadMessages("/api/v1/messages?threaded=true&newer_than="+O.lastMessageId,r)}O.count%O.showDelay===0&&(O.count=O.count+O.showDelay)}function D(b,c){if(J.get(P.truncate)&&!J.get(P.tiled))if(c){var d;d=2===c.find(".message").first().find("span.messagebody").length?2:1;for(var e=d;b+1>e;e++)a(c.find("span.messagebody")[e]).truncate({max_length:275})}else for(var f=M.feed.find("span.messagebody"),g=0;b>g;g++)a(f[g]).truncate({max_length:275})}function E(b){var c=a("#"+b.thread_id.toString()),d=c.find("."+N.replyNumber);if(d.length>0)d.text((b.thread_stats.updates-1).toString()),b.thread_stats.updates>2?d.next().text("replies"):2===b.thread_stats.updates?d.next().text("reply"):d.parents(".replies").remove();else if(2===b.thread_stats.updates){var e='<div class="'+N.replies+'"><a href="#'+b.thread_id+'" class="'+N.viewReplies+'"><span class="'+N.replyNumber+'">1</span> <span>reply</span></a></div>',f=c.find(".message");a(e).insertAfter(f)}}function F(){yam.getLoginStatus(function(a){a.authResponse?n(a):(M.landing.removeClass(N.hidden),yam.connect.loginButton("#yammer-login",function(a){a.authResponse&&n(a)}))})}var G=Yt.Constants,H=Yt.Util,I=Yt.Feed,J=Yt.Settings,K=Yt.Templates,L=J.oauth,M=H.getElements(),N=G.classes,O=G.defaultConfig,P=G.settingKeys;F()}(jQuery,moment,Handlebars,window,document);